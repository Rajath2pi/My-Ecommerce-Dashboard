    ...
    return (
        <>
            ...
            <nav className="flex-1 space-y-2 p-4 overflow-y-auto scrollbar-hide">
                ...
                <Link href="/home" className={`block rounded-xl hover:bg-gray-100 p-2 hover:dark:bg-gray-700 cursor-pointer ${currentPath === '/home' ? "bg-gray-100 p-2 dark:bg-gray-700": ""}`}>Home</Link>
